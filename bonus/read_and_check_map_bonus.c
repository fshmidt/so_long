...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   read_and_check_map_bonus.c                         :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: mbesan <mbesan@student.21-school.ru>       +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/01 20:53:29 by mbesan            #+#    #+#             */
/*   Updated: 2022/01/27 17:44:17 by mbesan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	length_height(int fd, t_map *map, int checker)
{
	int		h;
	char	*line;
...
int	read_and_check_map(t_map *map, char *map_name)
{
	...
	if (fd < 0)
		bug("Error\nCan't open file.\n");
	*map = zero_map(0);
	map->height = length_height(fd, map, 0);
	fd = open(map_name, O_RDONLY);
